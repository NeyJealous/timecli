...
{
    private static HeroBaseSpec CreateSpreadRifle()
    {
        var upgrades = new UpgradeSpec[]
        {
            ...
            U(3, 50, (UpgradeMod.FireRate, 2.0), (UpgradeMod.Projectiles, 6.0), (UpgradeMod.HeroDps, 2.0)),
            U(4, 75, (UpgradeMod.FireRate, 2.5), (UpgradeMod.HeroDps, 2.5)),
            U(5, 85, (UpgradeMod.UnitedFront, 1.2)),
            ...
            U(9, 150, (UpgradeMod.FireRate, 2.0), (UpgradeMod.Projectiles, 6.0), (UpgradeMod.HeroDps, 2.0)),
            ...
            U(15, 250, (UpgradeMod.FireRate, 2.0), (UpgradeMod.Projectiles, 6.0), (UpgradeMod.HeroDps, 2.0)),
            ...
            U(21, 350, (UpgradeMod.FireRate, 2.0), (UpgradeMod.Projectiles, 6.0), (UpgradeMod.HeroDps, 2.0)),
            U(22, 375, (UpgradeMod.FireRate, 2.5), (UpgradeMod.HeroDps, 2.5)),
            U(23, 385, (UpgradeMod.GoldFind, 1.5)),
            ...
            U(27, 450, (UpgradeMod.FireRate, 2.0), (UpgradeMod.Projectiles, 6.0), (UpgradeMod.HeroDps, 2.0)),
            ...
            U(33, 800, (UpgradeMod.Training, 4.0), (UpgradeMod.FireRate, 4.0), (UpgradeMod.Projectiles, 6.0)),
